    ...
    <div className="service-detail-container">
      <div className="service-detail-content">
        ...
        <div className="service-info">
          <h2>Giới thiệu</h2>
          <p>
            Đăng ký giấy khai sinh là thủ tục pháp lý đầu tiên và quan trọng
            nhất của mỗi cá nhân, xác nhận sự ra đời và các thông tin nhân thân
            cơ bản. Bài viết này sẽ hướng dẫn bạn các bước cần thiết để thực
            hiện thủ tục đăng ký giấy khai sinh tại Việt Nam.
          </p>

          <h2>1. Điều kiện đăng ký giấy khai sinh</h2>
          <ul>
            <li>
              Trẻ em sinh ra trên lãnh thổ Việt Nam đều phải được đăng ký khai
              sinh.
            </li>
            <li>
              Cha, mẹ hoặc người giám hộ có trách nhiệm đăng ký khai sinh cho
              trẻ.
            </li>
            <li>
              Thời hạn đăng ký khai sinh là 60 ngày kể từ ngày trẻ được sinh ra.
            </li>
          </ul>
          ...
          <ol>
            <li>
              Nộp hồ sơ tại UBND cấp xã/phường nơi cư trú của cha, mẹ hoặc nơi
              trẻ sinh ra.
            </li>
            <li>
              Cán bộ tư pháp kiểm tra, tiếp nhận hồ sơ và ghi vào sổ khai sinh.
            </li>
          ...
          <ul>
            ...
            <li>
              Trường hợp nộp hồ sơ muộn sau 60 ngày, cần làm thêm thủ tục khai
              sinh quá hạn.
            </li>
          </ul>
