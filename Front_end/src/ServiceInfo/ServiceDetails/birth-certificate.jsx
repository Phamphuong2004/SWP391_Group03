...
const BirthCertificate = () => {
    ...
    const service = administrativeServices.find(s => s.id === 'birth-certificate');
    ...
    const validateForm = () => {
        ...
        if (!files.birthProof) errors.birthProof = 'Vui lòng tải lên giấy chứng sinh';
        if (!files.householdBook) errors.householdBook = 'Vui lòng tải lên sổ hộ khẩu';
        if (!files.parentId) errors.parentId = 'Vui lòng tải lên CMND/CCCD của cha mẹ';
                    ...
                    <form onSubmit={handleSubmit} className="birth-certificate-form">
                        ...
                        <div className="form-section">
                            ...
                            <div className="form-group">
                                ...
                                />
                                {formErrors.fatherName && <span className="error-message">{formErrors.fatherName}</span>}
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                />
                                {formErrors.fatherId && <span className="error-message">{formErrors.fatherId}</span>}
                            </div>
                        </div>
                        ...
                        <div className="form-section">
                            ...
                            <div className="form-group">
                                ...
                                />
                                {formErrors.motherName && <span className="error-message">{formErrors.motherName}</span>}
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                />
                                {formErrors.motherId && <span className="error-message">{formErrors.motherId}</span>}
                            </div>
                        </div>
