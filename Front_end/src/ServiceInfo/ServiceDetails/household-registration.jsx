...
const HouseholdRegistration = () => {
    ...
    const service = administrativeServices.find(s => s.id === 'household-registration');
    ...
    const addHouseholdMember = () => {
        setFormData(prev => ({
            ...prev,
            householdMembers: [...prev.householdMembers, {
                name: '',
                id: '',
                relationship: '',
                dateOfBirth: '',
    ...
    const validateForm = () => {
        const errors = {};
        if (!formData.householdHead) errors.householdHead = 'Vui lòng nhập tên chủ hộ';
        if (!formData.householdHeadId) errors.householdHeadId = 'Vui lòng nhập CMND/CCCD chủ hộ';
        ...
        if (!formData.currentAddress) errors.currentAddress = 'Vui lòng nhập địa chỉ hiện tại';
        if (!formData.reason) errors.reason = 'Vui lòng nhập lý do đăng ký';
        if (!files.idCard) errors.idCard = 'Vui lòng tải lên CMND/CCCD';
        if (!files.proofOfResidence) errors.proofOfResidence = 'Vui lòng tải lên giấy tờ chứng minh nơi cư trú';
                    ...
                    <form onSubmit={handleSubmit} className="household-registration-form">
                        <div className="form-section">
                            ...
                            <div className="form-group">
                                ...
                                />
                                {formErrors.householdHead && <span className="error-message">{formErrors.householdHead}</span>}
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                />
                                {formErrors.householdHeadId && <span className="error-message">{formErrors.householdHeadId}</span>}
                            </div>
                        </div>
                        ...
                        <div className="form-section">
                            ...
                            <div className="form-group">
                                ...
                                />
                                {formErrors.currentAddress && <span className="error-message">{formErrors.currentAddress}</span>}
                            </div>
                        ...
                        <div className="form-section">
                            ...
                            {renderFileUpload('proofOfResidence', 'Giấy tờ chứng minh nơi cư trú')}
