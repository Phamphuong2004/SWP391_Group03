    ...
    <div className="service-detail-container">
      <div className="service-detail-content">
        ...
        <div className="service-info">
          <h2>Giới thiệu</h2>
          <p>
            Đăng ký hộ khẩu là thủ tục pháp lý quan trọng để xác lập nơi cư trú
            hợp pháp của cá nhân, hộ gia đình tại Việt Nam. Bài viết này sẽ
            hướng dẫn bạn các bước cần thiết để thực hiện thủ tục đăng ký hộ
            khẩu một cách nhanh chóng và đúng quy định.
          </p>

          <h2>1. Đối tượng và điều kiện đăng ký hộ khẩu</h2>
          <ul>
            <li>
              Công dân Việt Nam có nhu cầu đăng ký thường trú tại địa phương.
            </li>
            <li>Có chỗ ở hợp pháp tại địa chỉ đăng ký.</li>
            <li>
              Không thuộc các trường hợp bị cấm đăng ký thường trú theo quy định
              pháp luật.
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              Giấy tờ chứng minh chỗ ở hợp pháp (sổ đỏ, hợp đồng thuê nhà,
              v.v.).
            </li>
            <li>Sổ hộ khẩu cũ (nếu chuyển hộ khẩu).</li>
            <li>
              Giấy đăng ký kết hôn, giấy khai sinh của các thành viên (nếu có).
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              Nên liên hệ trước với Công an xã/phường để được hướng dẫn chi
              tiết.
            </li>
          </ul>
