...
const FamilyRelationship = () => {
    ...
    const service = administrativeServices.find(s => s.id === 'family-relationship');
    ...
    const handleFileUpload = async (fileType) => {
        ...
        try {
            ...
            formData.append('serviceType', isAdministrative ? 'administrative' : 'civil');
    ...
    const validateForm = () => {
        const errors = {};
        if (!formData.relationshipType) errors.relationshipType = 'Vui lòng chọn loại quan hệ';
        if (!formData.person1Name) errors.person1Name = 'Vui lòng nhập tên người thứ nhất';
        if (!formData.person1Id) errors.person1Id = 'Vui lòng nhập CMND/CCCD người thứ nhất';
        if (!formData.person1DateOfBirth) errors.person1DateOfBirth = 'Vui lòng nhập ngày sinh người thứ nhất';
        if (!formData.person1Gender) errors.person1Gender = 'Vui lòng chọn giới tính người thứ nhất';
        if (!formData.person2Name) errors.person2Name = 'Vui lòng nhập tên người thứ hai';
        if (!formData.person2Id) errors.person2Id = 'Vui lòng nhập CMND/CCCD người thứ hai';
        if (!formData.person2DateOfBirth) errors.person2DateOfBirth = 'Vui lòng nhập ngày sinh người thứ hai';
        if (!formData.person2Gender) errors.person2Gender = 'Vui lòng chọn giới tính người thứ hai';
        if (!formData.reason) errors.reason = 'Vui lòng nhập lý do xác nhận';
        if (!files.person1IdCard) errors.person1IdCard = 'Vui lòng tải lên CMND/CCCD người thứ nhất';
        if (!files.person2IdCard) errors.person2IdCard = 'Vui lòng tải lên CMND/CCCD người thứ hai';
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            submitData.append('serviceType', isAdministrative ? 'administrative' : 'civil');
                    ...
                    <form onSubmit={handleSubmit} className="family-relationship-form">
                        <div className="form-section">
                            ...
                            <div className="form-group">
                                <label htmlFor="relationshipType">Loại quan hệ cần xác nhận *</label>
                                <select
                                    id="relationshipType"
                                ...
                                >
                                    ...
                                    <option value="uncle-aunt-nephew-niece">Cô/dì/chú/bác - Cháu</option>
                                </select>
                                {formErrors.relationshipType && <span className="error-message">{formErrors.relationshipType}</span>}
                            </div>
                        </div>
                        ...
                        <div className="form-section">
                            ...
                            <div className="form-group">
                                ...
                                />
                                {formErrors.person1Name && <span className="error-message">{formErrors.person1Name}</span>}
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                />
                                {formErrors.person1Id && <span className="error-message">{formErrors.person1Id}</span>}
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                />
                                {formErrors.person1DateOfBirth && <span className="error-message">{formErrors.person1DateOfBirth}</span>}
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                {formErrors.person1Gender && <span className="error-message">{formErrors.person1Gender}</span>}
                            </div>
                        ...
                        <div className="form-section">
                            ...
                            <div className="form-group">
                                ...
                                />
                                {formErrors.person2Name && <span className="error-message">{formErrors.person2Name}</span>}
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                />
                                {formErrors.person2Id && <span className="error-message">{formErrors.person2Id}</span>}
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                />
                                {formErrors.person2DateOfBirth && <span className="error-message">{formErrors.person2DateOfBirth}</span>}
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                {formErrors.person2Gender && <span className="error-message">{formErrors.person2Gender}</span>}
                            </div>
                        ...
                        <div className="form-section">
                            ...
                            {renderFileUpload('birthCertificate', 'Giấy khai sinh (nếu có)', false)}
                            {renderFileUpload('householdBook', 'Sổ hộ khẩu (nếu có)', false)}
                            {renderFileUpload('marriageCertificate', 'Giấy đăng ký kết hôn (nếu có)', false)}
                            {renderFileUpload('otherDocuments', 'Giấy tờ khác (nếu có)', false)}
                        </div>
