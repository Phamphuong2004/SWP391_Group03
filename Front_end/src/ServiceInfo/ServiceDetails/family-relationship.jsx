    ...
    <div className="service-detail-container">
      <div className="service-detail-content">
        <div className="service-detail-header">
          <h1>
            Hướng dẫn thủ tục xác nhận quan hệ gia đình: Những điều cần biết
          </h1>
        ...
        <div className="service-info">
          <h2>Giới thiệu</h2>
          <p>
            Xác nhận quan hệ gia đình là thủ tục cần thiết để chứng minh mối
            quan hệ huyết thống hoặc nuôi dưỡng giữa các thành viên trong gia
            đình, phục vụ cho các mục đích pháp lý, hành chính hoặc dân sự. Bài
            viết này sẽ hướng dẫn bạn các bước cơ bản để thực hiện thủ tục xác
            nhận quan hệ gia đình tại Việt Nam.
          </p>
          ...
          <ul>
            ...
            <li>
              Các tài liệu bổ sung khác theo yêu cầu của cơ quan chức năng
            </li>
          </ul>
          ...
          <ol>
            <li>
              Nộp hồ sơ tại UBND cấp xã/phường nơi cư trú hoặc cơ quan có thẩm
              quyền
            </li>
