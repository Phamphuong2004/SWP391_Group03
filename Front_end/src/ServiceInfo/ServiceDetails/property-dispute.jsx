...
const PropertyDispute = () => {
    ...
    const service = {
        ...
        description: 'Dịch vụ hỗ trợ giải quyết các tranh chấp liên quan đến tài sản, quyền sở hữu, phân chia tài sản, v.v.',
        process: [
            'Tiếp nhận hồ sơ',
            'Xác minh thông tin',
            'Tư vấn và hòa giải',
    ...
    const validateForm = () => {
        ...
        if (!formData.disputeDescription) errors.disputeDescription = 'Vui lòng mô tả tranh chấp';
        if (!files.disputeDocuments) errors.disputeDocuments = 'Vui lòng tải lên tài liệu tranh chấp';
                    ...
                    <form onSubmit={handleSubmit} className="property-dispute-form">
                        ...
                        <div className="form-section">
                            ...
                            <div className="form-group">
                                ...
                                />
                                {formErrors.disputeDescription && <span className="error-message">{formErrors.disputeDescription}</span>}
                            </div>
                            <div className="form-group">
