...
const CivilContract = () => {
    ...
    const service = {
        ...
        description: 'Dịch vụ hỗ trợ soạn thảo, tư vấn và công chứng các loại hợp đồng dân sự như hợp đồng mua bán, cho thuê, vay mượn, và các giao dịch dân sự khác.',
        process: [
    ...
    const validateForm = () => {
        ...
        if (!formData.contractParties) errors.contractParties = 'Vui lòng nhập thông tin các bên tham gia';
        if (!files.identificationDocuments) errors.identificationDocuments = 'Vui lòng tải lên giấy tờ tùy thân';
                    ...
                    <form onSubmit={handleSubmit} className="civil-contract-form">
                        <div className="form-section">
                            ...
                            <div className="form-group">
                                ...
                                />
                                {formErrors.applicantName && <span className="error-message">{formErrors.applicantName}</span>}
                            </div>
                            <div className="form-group">
                        ...
                        <div className="form-section">
                            ...
                            <div className="form-group">
                                ...
                                {formErrors.contractType && <span className="error-message">{formErrors.contractType}</span>}
                            </div>
                            <div className="form-group">
                                ...
                                />
                                {formErrors.contractParties && <span className="error-message">{formErrors.contractParties}</span>}
                            </div>
                            <div className="form-group">
                            ...
                            <div className="form-group">
                                <label htmlFor="contractDescription">Mô tả nội dung hợp đồng</label>
                                <textarea
                        ...
                        <div className="form-section">
                            ...
                            {renderFileUpload('identificationDocuments', 'Giấy tờ tùy thân (CMND/CCCD/Hộ chiếu)')}
                            {renderFileUpload('contractDraft', 'Bản thảo hợp đồng (nếu có)', false)}
                            {renderFileUpload('supportingDocuments', 'Tài liệu hỗ trợ (nếu có)', false)}
