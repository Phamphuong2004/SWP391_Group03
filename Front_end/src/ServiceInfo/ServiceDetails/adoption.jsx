    ...
    <div className="service-detail-container">
      <div className="service-detail-content">
        ...
        <div className="service-info">
          <h2>Giới thiệu</h2>
          <p>
            Nhận con nuôi là một thủ tục pháp lý quan trọng, giúp trẻ em có hoàn
            cảnh khó khăn được chăm sóc, nuôi dưỡng trong môi trường gia đình
            mới. Bài viết này sẽ hướng dẫn bạn các bước cần thiết để thực hiện
          ...
          <ul>
            <li>
              Người nhận con nuôi phải từ 21 tuổi trở lên, có năng lực hành vi
              dân sự đầy đủ.
            </li>
            <li>
              Có điều kiện về sức khỏe, kinh tế, đạo đức tốt, không vi phạm pháp
              luật.
            </li>
            <li>
              Chênh lệch tuổi giữa người nhận nuôi và trẻ em ít nhất 16 tuổi.
            </li>
            <li>
              Không thuộc các trường hợp bị cấm nhận con nuôi theo quy định pháp
              luật.
            </li>
          </ul>
          ...
          <ol>
            ...
            <li>
              Ra quyết định công nhận việc nhận con nuôi nếu đủ điều kiện.
            </li>
          </ol>
          ...
          <ul>
            ...
            <li>
              Nên liên hệ trước với UBND xã/phường để được hướng dẫn chi tiết.
            </li>
          </ul>
