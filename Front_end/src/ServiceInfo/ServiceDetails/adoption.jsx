...
const Adoption = () => {
    ...
    const validateForm = () => {
        const errors = {};
        if (!formData.adoptiveParentName) errors.adoptiveParentName = 'Vui lòng nhập tên người nhận nuôi';
        if (!formData.adoptiveParentId) errors.adoptiveParentId = 'Vui lòng nhập CMND/CCCD người nhận nuôi';
        if (!formData.adoptiveParentAddress) errors.adoptiveParentAddress = 'Vui lòng nhập địa chỉ người nhận nuôi';
        if (!formData.adoptiveParentPhone) errors.adoptiveParentPhone = 'Vui lòng nhập số điện thoại';
        if (!formData.adoptiveParentEmail) errors.adoptiveParentEmail = 'Vui lòng nhập email';
        if (!formData.adoptiveParentJob) errors.adoptiveParentJob = 'Vui lòng nhập nghề nghiệp';
        if (!formData.adoptiveParentIncome) errors.adoptiveParentIncome = 'Vui lòng nhập thu nhập';
        if (!formData.childName) errors.childName = 'Vui lòng nhập tên trẻ';
        if (!formData.childDateOfBirth) errors.childDateOfBirth = 'Vui lòng nhập ngày sinh của trẻ';
        if (!formData.childGender) errors.childGender = 'Vui lòng chọn giới tính của trẻ';
        if (!formData.reason) errors.reason = 'Vui lòng nhập lý do nhận nuôi';
        if (!files.adoptiveParentIdCard) errors.adoptiveParentIdCard = 'Vui lòng tải lên CMND/CCCD người nhận nuôi';
        if (!files.childBirthCertificate) errors.childBirthCertificate = 'Vui lòng tải lên giấy khai sinh của trẻ';
        if (!files.biologicalParentConsent) errors.biologicalParentConsent = 'Vui lòng tải lên giấy đồng ý của cha mẹ đẻ';
    ...
    const renderFileUpload = (fileType, label, required = true) => {
        ...
        return (
            <div className="upload-section">
                ...
                {formErrors[fileType] && <span className="error-message">{formErrors[fileType]}</span>}
            </div>
        );
    };
                    ...
                    <form onSubmit={handleSubmit} className="adoption-form">
                        <div className="form-section">
                            ...
                            <div className="form-group">
                                <label htmlFor="adoptiveParentName">Họ và tên người nhận nuôi *</label>
                                <input
                                    type="text"
                                ...
                                />
                                {formErrors.adoptiveParentName && <span className="error-message">{formErrors.adoptiveParentName}</span>}
                            </div>

                            <div className="form-group">
                                <label htmlFor="adoptiveParentId">CMND/CCCD người nhận nuôi *</label>
                                <input
                                    type="text"
                                    id="adoptiveParentId"
                                ...
                                />
                                {formErrors.adoptiveParentId && <span className="error-message">{formErrors.adoptiveParentId}</span>}
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                />
                                {formErrors.adoptiveParentAddress && <span className="error-message">{formErrors.adoptiveParentAddress}</span>}
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                />
                                {formErrors.adoptiveParentPhone && <span className="error-message">{formErrors.adoptiveParentPhone}</span>}
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                />
                                {formErrors.adoptiveParentEmail && <span className="error-message">{formErrors.adoptiveParentEmail}</span>}
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                />
                                {formErrors.adoptiveParentJob && <span className="error-message">{formErrors.adoptiveParentJob}</span>}
                            </div>

                            <div className="form-group">
                                <label htmlFor="adoptiveParentIncome">Thu nhập hàng tháng *</label>
                                <input
                                    type="text"
                                ...
                                />
                                {formErrors.adoptiveParentIncome && <span className="error-message">{formErrors.adoptiveParentIncome}</span>}
                            </div>

                            <div className="form-group">
                                <label htmlFor="adoptiveParentMaritalStatus">Tình trạng hôn nhân</label>
                                <select
                        ...
                        <div className="form-section">
                            ...
                            <div className="form-group">
                                ...
                                />
                                {formErrors.childName && <span className="error-message">{formErrors.childName}</span>}
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                />
                                {formErrors.childDateOfBirth && <span className="error-message">{formErrors.childDateOfBirth}</span>}
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                {formErrors.childGender && <span className="error-message">{formErrors.childGender}</span>}
                            </div>
                        ...
                        <div className="form-section">
                            ...
                            <div className="form-group">
                                <label htmlFor="biologicalParentName">Họ và tên cha mẹ đẻ</label>
                                <input
                                    type="text"
                        ...
                        <div className="form-section">
                            ...
                            {renderFileUpload('adoptiveParentIdCard', 'CMND/CCCD người nhận nuôi')}
                            {renderFileUpload('adoptiveParentMarriageCertificate', 'Giấy đăng ký kết hôn (nếu có)', false)}
                            {renderFileUpload('adoptiveParentIncomeProof', 'Giấy tờ chứng minh thu nhập', false)}
                            {renderFileUpload('adoptiveParentCriminalRecord', 'Lý lịch tư pháp', false)}
                            {renderFileUpload('childBirthCertificate', 'Giấy khai sinh của trẻ')}
                            {renderFileUpload('biologicalParentConsent', 'Giấy đồng ý của cha mẹ đẻ')}
                            {renderFileUpload('biologicalParentIdCard', 'CMND/CCCD cha mẹ đẻ', false)}
                            {renderFileUpload('adoptionAgreement', 'Thỏa thuận nhận nuôi', false)}
                        </div>
