...
const Inheritance = () => {
    ...
    const service = {
        ...
        description: 'Dịch vụ hỗ trợ thực hiện các thủ tục liên quan đến thừa kế, phân chia di sản, và xác nhận quyền thừa kế.',
        process: [
            'Tiếp nhận hồ sơ',
    ...
    const validateForm = () => {
        ...
        if (!formData.deceasedName) errors.deceasedName = 'Vui lòng nhập tên người để lại di sản';
        if (!formData.relationship) errors.relationship = 'Vui lòng nhập mối quan hệ';
        if (!files.deathCertificate) errors.deathCertificate = 'Vui lòng tải lên giấy chứng tử';
                    ...
                    <form onSubmit={handleSubmit} className="inheritance-form">
                        ...
                        <div className="form-section">
                            ...
                            <div className="form-group">
                                ...
                                />
                                {formErrors.deceasedName && <span className="error-message">{formErrors.deceasedName}</span>}
                            </div>
                            <div className="form-group">
                                <label htmlFor="relationship">Mối quan hệ với người để lại di sản *</label>
                                <input
                                    type="text"
                                    id="relationship"
                                    name="relationship"
                                ...
                                />
                                {formErrors.relationship && <span className="error-message">{formErrors.relationship}</span>}
                            </div>
                            <div className="form-group">
                        ...
                        <div className="form-section">
                            ...
                            {renderFileUpload('inheritanceDocuments', 'Giấy tờ thừa kế (nếu có)', false)}
                            {renderFileUpload('propertyPapers', 'Giấy tờ tài sản (nếu có)', false)}
